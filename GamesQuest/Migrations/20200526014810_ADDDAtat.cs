...
{
    public partial class ADDDAtat : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AllProductss", x => x.ProductId);
                    table.ForeignKey(
                        name: "FK_AllProductss_Categories_CategoryId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AllProductss_CategoryId",
                table: "AllProductss",
                column: "CategoryId");
        }
